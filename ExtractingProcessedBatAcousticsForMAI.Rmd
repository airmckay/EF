...
na_bat5$full_filepath <- paste0(na_bat5$OUTDIR, "/", na_bat5$Filename)
head(na_bat5$full_filepath)
na_bat5$full_filepath <- gsub("\\\\", "/", na_bat5$full_filepath)
...
## NN sites 
 ...
 #      824       725        57        19       297       172       434       143       332 
 # EF9-NN-B 
 #     1584 
...
EF7CC <- bats1 %>% filter(str_detect(Site, pattern = "EF7")) #670 files for both sites
