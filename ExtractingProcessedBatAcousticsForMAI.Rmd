...
# "C:/Users/apmc/OneDrive - Norwegian University of Life Sciences/5. EcoForest/Data/Acoustics/Bat Acoustic Data/ROutputs/ExportingBatAcousticData_2023-10-09"
```
...
## In the future - check for NAs 
## For some reason, there were 98 files we later found that did not have a filepath - which means they were not found when I searched through the acoustics folder and collected all files with a 000.wav ending... 
```
